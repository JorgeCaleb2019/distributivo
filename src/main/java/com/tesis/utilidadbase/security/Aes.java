...
package com.tesis.utilidadbase.security;
...
public class Aes {
    ...
    private final static String alg = "AES_256";
    private final static String cI = "AES/CBC/PKCS5Padding";
    
    private final static String iv="ZAB234YGcj143rfg";
    private final static String key="10OLKMZ509iolmv410OLKMZ509iolmv4";

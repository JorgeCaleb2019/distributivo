...
public class GrupoFacade extends AbstractFacade<Grupo> {
    ...
    @Override
    public InfoTable<Grupo> loadTable(Integer first, Integer pageSize, List<String> search,String addquery,Map<String,Object> parametros) {
        ...
        InfoTable<Grupo> info = new InfoTable();
